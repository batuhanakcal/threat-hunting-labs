...
| **Behavior** | Data staged into cloud storage and retrieved by parties outside the organisation (T1567.002 / T1530 — Data from Cloud Storage Object). |
...
READ** — meaning anyone could not only download from the bucket, but upload into it.
...
*OPEN_BUCKET_PLEASE_FIX*. This is a well-known internet phenomenon — scanners and researchers
...
3. The web archive itself left the organisation seven times; if it contains configuration files
